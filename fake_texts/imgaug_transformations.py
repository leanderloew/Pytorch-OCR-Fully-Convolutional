...
augmentations=iaa.Sequential([
            ...
            sometimes_2(iaa.Invert(1, per_channel=True)), 
            ...
            sometimes_2(iaa.AddToHueAndSaturation((-20, 20))), # change hue and saturation
            sometimes_2(iaa.ContrastNormalization((0.5, 2.0), per_channel=0.5)), # improve or worsen the contrast
            sometimes_2(iaa.ElasticTransformation(alpha=(0, 0.5), sigma=0.2)), # move pixels locally around (with random strengths)
            sometimes_2(iaa.PiecewiseAffine(scale=(0.001, 0.005))), 
